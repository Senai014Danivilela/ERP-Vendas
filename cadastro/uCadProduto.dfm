inherited frmCadProduto: TfrmCadProduto
  ...
  inherited FDQListagem: TFDQuery
    ...
    object FDQListagemvalor: TFMTBCDField
      DisplayLabel = 'VALOR'
      FieldName = 'valor'
      Origin = 'p'
      Precision = 18
    ...
    object FDQListagemquantidade: TFMTBCDField
    ...
    object FDQListagemcategoriaId: TIntegerField
      DisplayLabel = 'COD.CATEGORIA'
      FieldName = 'categoriaId'
      Origin = 'p'
    end
    object FDQListagemDescricaoCategoria: TStringField
  ...
  object FDQCategoria: TFDQuery
    ...
    Left = 476
    Top = 8
    object Codigo: TFDAutoIncField
      FieldName = 'categoriaId'
      Origin = 'categoriaId'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
      DisplayFormat = 'Codigo'
    end
